...
// ✅ Correct way — Use public paths (NO imports from /public)
        ...
        <>
            <div id="version" className="md:scroll-m-[180px] scroll-m-28">
                ...
                <div className="flex item-center justify-between">
                    <h3 className="text-MidnightNavyText text-2xl mt-4 font-semibold mb-6 dark:text-white">
                        Pacakge Versions
                    </h3>
                ...
                <div className="w-full flex justify-between lg:gap-0 gap-6 lg:flex-nowrap flex-wrap p-6 rounded-md border border-border dark:border-dark_border">
                    {PackageVersions.map((item) => (
                        <div
                            key={item.id}
                            className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b 
                                       lg:border-e lg:last:border-e-0 last:border-b-0 
                        ...
                        >
                            <Image
                                ...
                                className="mx-auto"
                            />
                            <h5 className="text-2xl font-bold mt-3.5 text-MidnightNavyText dark:text-white">
                                {`v${item.version}`}
                            </h5>
                ...
                <div className="mt-5">
                    <p className="text-base font-medium text-SlateBlueText dark:text-opacity-80">
                        Symposium Tailwind NextJs Template is built with Tailwindcss and Nextjs.
                    </p>
                    <p className="text-base font-medium text-SlateBlueText dark:text-opacity-80">
            ...
            {/* Mobile Sidebar */}
            <div
                className={`lg:hidden block fixed top-0 right-0 h-full w-full bg-white dark:bg-darkmode 
                            shadow-lg transform transition-transform duration-300 max-w-xs 
                            ${docNavbarOpen ? "translate-x-0" : "translate-x-full"} z-50`}
            >
